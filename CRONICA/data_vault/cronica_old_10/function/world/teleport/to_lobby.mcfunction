...
# タグ管理
tag @s remove TAG.cronica_dev.CT_ZERO
tag @s remove TAG.cronica_dev.CT_HANDICAP
tag @s remove TAG.cronica_dev.GAMING
tag @s remove TAG.cronica_dev.GAMING.spectate
tag @s remove TAG.cronica_dev.GAMING.practice
...
# インベントリ
clear @s
function cronica_dev:player/status/inventory/kit/lobby_set

# メインロビーへテレポート
function cronica_dev:world/stage/lobby/teleport/enter
...
# サーバー参加時通知
execute as @s[tag=TAG.cronica_dev.STATUS.JoinServer] run title @s title [{"text":"<<","color":"gray","bold":false},{"text":" CRONICA ","color":"green","bold":true},{"text":">>","color":"gray","bold":false}]
execute as @s[tag=TAG.cronica_dev.STATUS.JoinServer] run title @s subtitle [{"text":"Presented By TicK-tag"}]
execute as @s[tag=TAG.cronica_dev.STATUS.JoinServer] run tag @s remove TAG.cronica_dev.STATUS.JoinServer
# =================================================================================================
