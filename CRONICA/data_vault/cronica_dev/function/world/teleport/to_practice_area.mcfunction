...
# タグ管理
tag @s add TAG.cronica_dev.GAMING
tag @s add TAG.cronica_dev.GAMING.practice
...
# インベントリ
clear @s
function cronica_dev:player/status/inventory/kit/free_battle_set

# 練習場へテレポート
function cronica_dev:world/stage/practice_area/teleport/enter
