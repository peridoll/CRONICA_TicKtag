...
# # Select
# function cronica:player/character/list/ikaros/select/flying_feather/get
# function cronica:player/character/list/ikaros/select/judgment_stone/get
# function cronica:player/character/list/ikaros/select/blazing_shield/get