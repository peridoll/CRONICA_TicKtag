  ...
  ## 指定した数値の強さで視点の方向にかっ飛ばす
    ...
    # データ管理
      ...
      # 射出力を入力 : 射出力は、-1000000 ～ 1000000 の範囲で指定可能 ( 1000 = 1ブロック )
        ...
        $scoreboard players set #VectorMaster_X SCORE.cronica.STATUS.MotionVector.Power $(VectorPowerX)
        $scoreboard players set #VectorMaster_Y SCORE.cronica.STATUS.MotionVector.Power $(VectorPowerY)
        $scoreboard players set #VectorMaster_Z SCORE.cronica.STATUS.MotionVector.Power $(VectorPowerZ)

      # 上限・下限の設定
        execute if score #VectorMaster_X SCORE.cronica.STATUS.MotionVector.Power matches 1000001.. run scoreboard players set #VectorMaster_X SCORE.cronica.STATUS.MotionVector.Power 1000000
        execute if score #VectorMaster_X SCORE.cronica.STATUS.MotionVector.Power matches ..-1000001 run scoreboard players set #VectorMaster_X SCORE.cronica.STATUS.MotionVector.Power -1000000
        execute if score #VectorMaster_Y SCORE.cronica.STATUS.MotionVector.Power matches 1000001.. run scoreboard players set #VectorMaster_Y SCORE.cronica.STATUS.MotionVector.Power 1000000
        execute if score #VectorMaster_Y SCORE.cronica.STATUS.MotionVector.Power matches ..-1000001 run scoreboard players set #VectorMaster_Y SCORE.cronica.STATUS.MotionVector.Power -1000000
        execute if score #VectorMaster_Z SCORE.cronica.STATUS.MotionVector.Power matches 1000001.. run scoreboard players set #VectorMaster_Z SCORE.cronica.STATUS.MotionVector.Power 1000000
        execute if score #VectorMaster_Z SCORE.cronica.STATUS.MotionVector.Power matches ..-1000001 run scoreboard players set #VectorMaster_Z SCORE.cronica.STATUS.MotionVector.Power -1000000
