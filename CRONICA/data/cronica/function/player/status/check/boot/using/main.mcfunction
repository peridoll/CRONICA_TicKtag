...
# Ammo
# execute if data storage cronica:context ItemCategory{Value:"Ammo"} if score @s SCORE.cronica.STATUS.ItemUsing matches 1.. run function cronica:player/status/check/boot/using/category/ammo
# WeaponSkill
# execute if data storage cronica:context ItemCategory{Value:"WeaponSkill"} if score @s SCORE.cronica.STATUS.ItemUsing matches 1.. run function cronica:player/status/check/boot/using/category/weapon_skill
# PassiveSkill
# execute if data storage cronica:context ItemCategory{Value:"PassiveSkill"} if score @s SCORE.cronica.STATUS.ItemUsing matches 1.. run function cronica:player/status/check/boot/using/category/passive_skill
# ExtraSkill
# execute if data storage cronica:context ItemCategory{Value:"ExtraSkill"} if score @s SCORE.cronica.STATUS.ItemUsing matches 1.. run function cronica:player/status/check/boot/using/category/extra_skill
# SelectSkill
execute if data storage cronica:context ItemCategory{Value:"SelectSkill"} if score @s SCORE.cronica.STATUS.ItemUsing matches 1.. run function cronica:player/status/check/boot/using/category/select_skill
# OtherItem
# execute if data storage cronica:context ItemCategory{Value:"OtherItem"} if score @s SCORE.cronica.STATUS.ItemUsing matches 1.. run function cronica:player/status/check/boot/using/category/other_item
#//////////////////////////////////////////////////////////////////////////////////////////////////
# データリセット
