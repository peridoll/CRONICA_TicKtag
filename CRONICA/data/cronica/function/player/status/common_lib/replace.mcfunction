...
# $execute if data storage cronica:context ItemID{Offhand:"$(ItemID)"} run loot replace entity @s weapon.offhand loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# data remove storage cronica:context ItemID

# # ホットバー
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:0b}]}] run loot replace entity @s hotbar.0 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:1b}]}] run loot replace entity @s hotbar.1 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:2b}]}] run loot replace entity @s hotbar.2 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:3b}]}] run loot replace entity @s hotbar.3 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:4b}]}] run loot replace entity @s hotbar.4 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:5b}]}] run loot replace entity @s hotbar.5 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:6b}]}] run loot replace entity @s hotbar.6 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:7b}]}] run loot replace entity @s hotbar.7 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
# $execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"ItemID": "$(ItemID)"}},Slot:8b}]}] run loot replace entity @s hotbar.8 loot cronica:character/$(MasterID)/$(MasterType)/$(ItemID)
