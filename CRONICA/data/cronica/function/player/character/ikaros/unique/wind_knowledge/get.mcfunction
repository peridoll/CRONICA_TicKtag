...
# 基本形態
execute if score @s SCORE.cronica.MODE.wind_knowledge matches 0 run function cronica:player/status/common_lib/modify {ItemID: "wind_knowledge", Model: "common/default", Value:""}
# =================================================================================================
