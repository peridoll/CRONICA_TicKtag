...
#強制終了
execute as @a[tag=TAG.cronica.preview] if score @s SCORE.cronica.TIMER.test_item.reset_request matches 100.. run function cronica:player/character/sleet/select/test_item/library/finish
