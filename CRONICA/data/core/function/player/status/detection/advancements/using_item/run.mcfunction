...
##【 IMPULSE 】
  ...
  # /* メインハンドを優先実行するため、オフハンドを取得したのちにメインハンドを取得して塗りつぶす */
    ...
    # オフハンド取得
      ...
      execute if data storage cronica:temp ItemUsing{OffHandStatus: ready} run function core:player/status/detection/advancements/using_item/get_off_hand
    ...
    # メインハンド取得
      ...
      execute if data storage cronica:temp ItemUsing{MainHandStatus: ready} run function core:player/status/detection/advancements/using_item/get_main_hand

  ## 後続処理呼び出し

    # アイテム使用時処理
      function core:player/status/detection/advancements/using_item/character_boot with storage cronica:temp ItemUsing
      function core:player/status/detection/advancements/using_item/other_boot with storage cronica:temp ItemUsing
