...
##【 IMPULSE 】
  ...
  ## プレイヤー管理
    ...
    # キャラクター関連リセット
      function core:player/inventory/full_execute/func/character_func/macro/run {Action: "library/common/leave"}
  ...
  ## ワールド管理
    ...
    # メインロビーへテレポート
      function core:world/macro/teleport with storage cronica:stage_position lobby.enter
